 ...
 * @version 1.0.0
 */
public class GetGoodsClassInfoServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		session.setAttribute("goodsClassInfo", list);
		
		response.sendRedirect("/server/view/goodsClass/goodsClassInfo.jsp");
